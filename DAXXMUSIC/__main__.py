...
async def init():
    ...
    await DAXX.start()
    try:
        await DAXX.stream_call("https://graph.org/file/26275a44083eea4fd097e.jpg")
    except NoActiveGroupCall:
        LOGGER("SPARTAN").error(
    ...
    LOGGER("SPARTAN").info(
        "╔═════ஜ۩۞۩ஜ════╗\n  ☠︎︎𝗠𝗔𝗗𝗘 𝗕𝗬 𝗠𝗥 SPARTAN☠︎︎\n╚═════ஜ۩۞۩ஜ════╝"
    )
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("SPARTAN").info("𝗦𝗧𝗢𝗣 SPARTAN 𝗠𝗨𝗦𝗜𝗖🎻 𝗕𝗢𝗧..")
